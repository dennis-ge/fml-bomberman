...
REWARDS = {
    ...
    MOVED_AWAY_FROM_COIN_1: [-3, ranges["small_neg_2"]],
    e.COIN_COLLECTED: [12, ranges["medium_pos"]],
    DID_NOT_COLLECT_COIN_2: [12, ranges["medium_neg"]],
    VALID_ACTION_3: [20, [2]],
    INVALID_ACTION_3: [-30, [-15]],
    MOVED_OUT_OF_BLAST_RADIUS_4: [22, ranges["medium_pos"]],
    STAYED_IN_BLAST_RADIUS_4: [-22, ranges["medium_neg"]],
    # MOVED_TOWARDS_BOMB_FIELDS_5: [-27, ranges["medium_neg"]], #no occurence
    # MOVED_AWAY_FROM_BOMB_FIELDS_5: [35, ranges["medium_pos"]],
    STAYED_OUT_OF_BOMB_RADIUS_6: [50, ranges["medium_pos"]],
    ...
    MOVED_TOWARDS_ENEMY_11: [1, ranges["small_pos_2"]],
    MOVED_AWAY_FROM_ENEMY_11: [-1, ranges["small_pos_2"]],
    KILLED_ENEMY_IN_TRAP_12: [200, ranges["high_pos"]],
    DID_NOT_KILL_ENEMY_IN_TRAP_12: [-100, ranges["medium_neg"]],
    MOVED_INTO_DANGEROUS_POSITION_13: [-50, ranges["medium_neg"]],
    DID_NOT_MOVE_INTO_DANGEROUS_POSITION_13: [5, ranges["medium_neg"]],
    PLACED_BOMB_NEXT_TO_CRATE_7: [30, ranges["small_pos_2"]],
