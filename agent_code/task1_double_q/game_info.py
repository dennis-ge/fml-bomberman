...
def get_nearby_enemies(field_max_x: int, field_max_y: int, pos: Tuple[int, int], enemies_pos: List[Tuple[int, int]]):
    enemies_nearby = []
...
def wait_is_intelligent(pos: Tuple[int, int], bomb_fields: List[Tuple[int, int]], safe_fields: List[Tuple[int, int]]) -> bool:
    """
