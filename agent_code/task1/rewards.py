...
REWARDS_LIST = [
    ...
    # [VALID_ACTION, 2, [2]],
    [MOVED_TOWARDS_CRATE, 3, ranges["small_pos"]],
    [e.CRATE_DESTROYED, 5, ranges["small_pos"]],
    [MOVED_AWAY_FROM_DANGEROUS_ENEMY, 3, ranges["small_pos"]],
    [PLACED_BOMB_NEXT_TO_CRATE, 10, ranges["small_pos"]],
    [e.BOMB_DROPPED, 5, ranges["small_pos"]],
    [e.COIN_FOUND, 5, ranges["small_pos"]],
    [MOVED_TOWARDS_ENEMY, 10, ranges["small_pos_2"]],
    [MOVED_TOWARDS_COIN, 12, ranges["small_pos_2"]],
    [MOVED_AWAY_FROM_BOMB_FIELDS, 40, ranges["medium_pos"]],
    [STAYED_OUT_OF_BOMB_RADIUS, 40, ranges["medium_pos"]],
    [e.COIN_COLLECTED, 20, ranges["medium_pos"]],
    [PLACED_BOMB_NEXT_TO_OPPONENT, 40, [30]],
    [MOVED_OUT_OF_BLAST_RADIUS, 40, ranges["medium_pos"]],
    [e.SURVIVED_ROUND, 50, ranges["high_pos"]],
    [KILLED_ENEMY_IN_SAFE_DEAD, 70, ranges["high_pos"]],
    ...
    [e.MOVED_LEFT, -1, [-1]],
    [e.BOMB_EXPLODED, -2, [-1]],
    [MOVED_AWAY_FROM_CRATE, -5, ranges["small_neg"]],
    [MOVED_TOWARDS_DANGEROUS_ENEMY, -5, ranges["small_neg_2"]],
    # [INVALID_ACTION, -15, [-15]],
    [PLACED_USELESS_BOMB, -50, ranges["medium_neg"]],
    [e.WAITED, -25, [-20]],
    [MOVED_AWAY_FROM_COIN, -15, ranges["small_neg_2"]],
    [DID_NOT_COLLECT_COIN, -30, ranges["medium_neg"]],
    [DID_NOT_KILL_ENEMY_IN_SAFE_DEAD, -30, ranges["medium_neg"]],
    [e.GOT_KILLED, -50, [-50]],
    [e.INVALID_ACTION, -50, [-50]],
    [MOVED_TOWARDS_BOMB_FIELDS, -45, ranges["medium_neg"]],
    [MOVED_INTO_BOMB_RADIUS, -45, ranges["medium_neg"]],
    [STAYED_IN_BLAST_RADIUS, -45, ranges["medium_neg"]],
    [e.KILLED_SELF, -70, [-100, -200]],
]
